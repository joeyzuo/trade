...
public class ContractRestApiTest {
    ...
    public static void main(String[] args) {
       ...
       ContractOrderResult sOrderResult = client.getContractOrder(OrderType.LIMIT, "", null);
        ...
        List<ContractOrderResult> historyOrders = client.getContractHistoryOrders(
                ContractHistoryOrderRequest.builder().orderId(853795481927657216L)
                        .build()
        );
...
//            ContractOrderRequest.builder().symbol("BTC-PERP-REVBITCOIN TEST")
//                    .leverage("10")
...
//        System.out.println(orderResultCancel);
        ...
        BatchCancelOrderResult batchCancelOrderResult = client.batchCancelContractOrder(
                BatchCancelOrderRequest.builder()
                        .symbolList(Lists.newArrayList("BTC-SWAP-USDT"))
                        .build()
        );
...
//        System.out.println(modifyMarginResult);
        ...
        List<TradeHistoryItem> tradeHistoryItems = client.getContractTrades("BTC-SWAP-USDT", null);
        System.out.println(tradeHistoryItems);

        System.out.println("\n ------get contract klines-----");
        List<Candlestick> candlesticks = client.getContractCandlestickBars("BTC-SWAP-USDT", CandlestickInterval.ONE_MINUTE, null, null);
